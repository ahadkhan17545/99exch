...
function Bookmaker({ bookmaker }) {
    ...
    return (
        <>
            <div className='hidden lg:block !mt-[.25rem]'>
                        ...
                        <div className='block w-full overflow-x-hidden !relative text-[.75rem]'>
                            <table className='w-full relative mb-0 [caption-side:bottom] border-collapse text-[.75rem] text-[#212529] bg-[#faf8d8] align-top border-[#dee2e6]'>
                                <thead className='align-bottom text-[.75rem]'>
                                    <th className='w-[40%] p-[5px] !border-b-[1px] !border-b-[#7e97a7]'></th>
                                    <th colSpan={2} className='text-right pr-[20px] p-[5px] !border-b-[1px] !border-b-[#7e97a7] !text-[#000000]'>Back</th>
                                    <th colSpan={2} className='text-left pl-[20px] p-[5px] !border-b-[1px] !border-b-[#7e97a7] border-t-[none] !text-[#000000]'>Lay</th>
                                </thead>

                                <tbody className='border-t-[1px_solid_#7e97a7] [vertical-align:inherit] text-[.75rem] [word-wrap:break-word]'>
                                    {bookmaker?.marketRunners.map((runner, index) => (
                                        <>
                                            {
                                                runner.status == "suspended" && (

                                                    <div className='h-[46px] bg-[#243a4866] absolute w-[60%] left-[40%] z-[5] text-center' >
                                            ...
                                            <tr key={index} className='relative border-b-[1px] border-b-[#7e97a7]' >
                                                <td className='w-[40%] text-left pl-[6px] align-middle text-[.75rem] px-[0] py-[1.5px] font-bold border-t-[none] bg-transparent border-b-[1px] border-b-[#7e97a7] [box-shadow:inset_0_0_0_9999px_transparent]'>
                                                ...
                                                <td className='p-0 align-middle text-center text-[.75rem] font-bold border-t-[none] bg-transparent border-b-[1px] border-b-[#7e97a7] [box-shadow:inset_0_0_0_9999px_transparent]'>
                                                    <dl className='bg-[linear-gradient(90deg,_rgba(130,_183,_221,_.15)_0,_rgba(130,_183,_221,_.8)_65%)] h-[46px] flex m-0 p-0 text-center text-[.75rem] font-bold'>
                                                        <dd className='cursor-pointer w-[10%] flex-[1] p-[2px]  justify-center items-center flex m-0 relative text-center text-[.75rem] font-bold'>
                                                            <button className={` no-underline cursor-pointer w-[calc(100%-2px)] h-[calc(100% - 2px)] px-[0] py-[2px] m-0 rounded-[4px] text-center text-[.75rem] font-bold ${type == 'back' && rate == runner?.back_3_price && rate > 0 && '!bg-[#1a8ee1] text-[#fff] [box-shadow:inset_0_1px_3px_#00000080]'}`}
                                                                onClick={() => selectRate(runner?.back_3_price, 'back', index)}
                                                            >
                                                                <span className='font-bold block text-[0.688rem] min-w-[50px] !relative cursor-pointer text-center'>{formatPrice(runner?.back_3_price)}</span>
                                                                <span className='text-[0.688rem] block font-normal min-w-[50px] !relative text-center' >{formatPrice(runner?.back_3_size)}</span>
                                                            </button>
                                                        </dd>
                                                        <dd className='cursor-pointer w-[10%] flex-[1] p-[2px]  justify-center items-center flex m-0 relative text-center text-[.75rem] font-bold'>
                                                            <button className={`cursor-pointer w-[calc(100%-2px)] h-[calc(100% - 2px)] px-[0] py-[2px] m-0 rounded-[4px] text-center text-[.75rem] font-bold ${type == 'back' && rate == runner?.back_2_price && rate > 0 && '!bg-[#1a8ee1] text-[#fff] [box-shadow:inset_0_1px_3px_#00000080]'}`}
                                                                onClick={() => selectRate(runner?.back_2_price, 'back', index)}
                                                            >
                                                                <span className='font-bold block text-[0.688rem] min-w-[50px] !relative cursor-pointer text-center'>{formatPrice(runner?.back_2_price)}</span>
                                                                <span className='text-[0.688rem] block font-normal min-w-[50px] !relative text-center' >{formatPrice(runner?.back_2_size)}</span>
                                                            </button>
                                                        </dd>
                                                        <dd className={`cursor-pointer w-[10%] flex-[1] p-[2px] items-center flex m-0 relative text-center text-[.75rem] font-bold`}>
                                                            <button className={`w-full h-full p-0 m-0 bg-[#72bbef] border-[1px] border-[solid] border-[#fff] rounded-[4px]  text-center text-[.75rem] font-bold ${type == 'back' && rate == runner?.back_1_price && rate > 0 && '!bg-[#1a8ee1] text-[#fff] [box-shadow:inset_0_1px_3px_#00000080]'}`}
                                                                onClick={() => selectRate(runner?.back_1_price, 'back', index)}
                                                            >
                                                                <span className='font-bold block text-[0.688rem] min-w-[50px] !relative w-[calc(100%-2px)] cursor-pointer text-center'>{formatPrice(runner?.back_1_price)}</span>
                                                                <span className='text-[0.688rem] block font-normal min-w-[50px] !relative w-[calc(100%-2px)] text-center'>{formatPrice(runner?.back_1_size)}</span>
                                                            </button>
                                                        </dd>
                                                    </dl>
                                                </td>
                                                <td colSpan={3} className='p-0 align-middle text-center text-[12px] font-bold border-t-[none] bg-transparent border-b-[1px] border-b-[#7e97a7] [box-shadow:inset_0_0_0_9999px_transparent]'>
                                                    <dl className='bg-[linear-gradient(270deg,_rgba(231,_170,_184,_.15)_5%,_rgba(231,_170,_184,_.8)_60%)] h-[46px] flex m-0 p-0 text-center text-[.75rem] font-bold'>
                                                        <dd className={`cursor-pointer w-[10%] flex-[1] p-[2px]   items-center flex m-0 relative text-center text-[.75rem] font-bold `}>
                                                            <button className={` h-full w-full p-0 m-0 border-[1px] border-[solid] border-[#fff] rounded-[4px]  text-center text-[.75rem] font-bold ${type == 'lay' && rate == runner?.lay_1_price && rate > 0 ? 'bg-[#f4496d] !text-[#fff] [box-shadow:inset_0_1px_3px_#00000080]' : 'bg-[#faa9ba] '}`}
                                                                onClick={() => selectRate(runner?.lay_1_price, 'lay', index)}
                                                            >
                                                                <span className='font-bold block text-[0.688rem] min-w-[50px] !relative w-[calc(100%-2px)] text-center'>{formatPrice(runner?.lay_1_price)}</span>
                                                                <span className='text-[0.688rem] block font-normal min-w-[50px] !relative w-[calc(100%-2px)]' >{formatPrice(runner?.lay_1_size)}</span>
                                                            </button>
                                                        </dd>
                                                        <dd className={`cursor-pointer w-[10%] flex-[1] p-[2px]  justify-center items-center flex m-0 relative text-center text-[.75rem] font-bold `}>
                                                            <button className={` cursor-pointer w-[calc(100%-2px)] h-[calc(100% - 2px)] px-[0] py-[2px] m-0 rounded-[4px] text-center text-[.75rem] font-bold ${type == 'lay' && rate == runner?.lay_2_price && rate > 0 ? 'bg-[#f4496d] text-[#fff] [box-shadow:inset_0_1px_3px_#00000080]' : 'text-[#a9616d]'}`}
                                                                onClick={() => selectRate(runner?.lay_2_price, 'lay', index)}
                                                            >
                                                                <span className='font-bold block text-[0.688rem] min-w-[50px] !relative text-center'>{formatPrice(runner?.lay_2_price)}</span>
                                                                <span className='block font-normal text-[0.688rem] min-w-[50px] !relative text-center'>{formatPrice(runner?.lay_2_size)}</span>
                                                            </button>
                                                        </dd>
                                                        <dd className={`cursor-pointer w-[10%] flex-[1] p-[2px]  justify-center items-center flex m-0 relative text-center text-[.75rem] font-bold `}>
                                                            <button className={`w-[calc(100%-2px)] h-[calc(100% - 2px)] px-[0] py-[2px] m-0 rounded-[4px] text-center text-[.75rem] font-bold ${type == 'lay' && rate == runner?.lay_3_price && rate > 0 ? 'bg-[#f4496d] text-[#fff] [box-shadow:inset_0_1px_3px_#00000080]' : 'text-[#a9616d]'} `}
                                                                onClick={() => selectRate(runner?.lay_3_price, 'lay', index)}
                                                            >
                                                                <span className='font-bold block text-[0.688rem] min-w-[50px] !relative text-center'>{formatPrice(runner?.lay_3_price)}</span>
                                                                <span className='font-normal block text-[0.688rem] min-w-[50px] !relative text-center'>{formatPrice(runner?.lay_3_size)}</span>
                                                            </button>
                                                        </dd>
                                                    </dl>
                                                </td>
            ...
            {/* Mobile */}
            < div className='lg:hidden !mt-[.25rem]' >
                <div className='-mt-[2.5px] text-[.75rem] relative flex flex-col min-w-[0] [word-wrap:break-word] bg-[linear-gradient(180deg,_#ffffff,_#ffffff_42%)] bg-clip-border border-[1px] border-[solid] border-[#c8ced3] rounded-[.25rem] !mb-0'>
                    <div className='bg-[#ffffff] text-[#000000] border-[none] p-0 text-[13px] border-b-[1px] border-b-[#7e97a7] flex [word-wrap:break-word]'>
                        <strong className='h-[30px] leading-[30px] text-[#ffffff] float-left font-bold pr-[30px] pl-[10px] relative bg-[linear-gradient(-180deg,_#2E4B5E_0%,_#243A48_82%)] rounded-tr-[15px] text-[0.75rem] !w-auto'>
                            {bookmaker?.market_name}
                                ...
                                <tbody className='border-t-[1px_solid_#7e97a7] [vertical-align:inherit] text-[.75rem] [word-wrap:break-word]'>
                                    {bookmaker?.marketRunners.map((runner, index) => (
                                        <>
                                            {
                                                runner.status == "suspended" && (
                                                    <div className='h-[46px] bg-[#243a4866] absolute w-[35%] left-[65%] z-[5] text-center' >
                                                        <span className='leading-[46px] text-[12px] font-normal opacity-[.8] text-[#ffffff] [text-shadow:0_1px_4px_rgba(0,_0,_0,_.5)] text-center normal-case p-[.5rem] bg-transparent [box-shadow:inset_0_0_0_9999px_transparent]'> Suspended </span>
                                                    </div>
                                                )
                                            }
                                                ...
                                                <td colSpan={3} className='p-0 align-middle text-center text-[12px] font-bold border-t-[none] bg-transparent border-b-[1px] border-b-[#7e97a7] [box-shadow:inset_0_0_0_9999px_transparent]'>
                                                    <dl className='bg-[linear-gradient(270deg,_rgba(231,_170,_184,_.15)_5%,_rgba(231,_170,_184,_.8)_60%)] h-[46px] flex m-0 p-0 text-center text-[.75rem] font-bold'>
                                                        <dd className='cursor-pointer w-[10%] flex-[1] p-[2px]   items-center flex m-0 relative text-center text-[.75rem] font-bold'>
                                                            <button className={` h-full w-full p-0 m-0 border-[1px] border-[solid] border-[#fff] rounded-[4px]  text-center text-[.75rem] font-bold ${type == 'lay' && rate == runner?.lay_1_price && rate > 0 ? 'bg-[#f4496d] !text-[#fff] [box-shadow:inset_0_1px_3px_#00000080]' : 'bg-[#faa9ba] '}`}
                                                                onClick={() =>
                                                                    selectRate(runner?.lay_1_price, 'lay', index)
                                                                }
                                                            >
                                                                <span className='font-bold block text-[0.688rem] min-w-[50px] !relative w-[calc(100%-2px)] text-center'>{formatPrice(runner?.lay_1_price)}</span>
                                                                <span className='text-[0.688rem] block font-normal min-w-[50px] !relative w-[calc(100%-2px)]' >{formatPrice(runner?.lay_1_size)}</span>
