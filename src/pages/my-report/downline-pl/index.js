...
function DownlinePL() {
    ...
    const [formData, setFormData] = useState({
        ...
        "from_date": from_date ? from_date : moment().subtract(7, 'days').format('YYYY-MM-DD'),
    ...
    const filterDownlinePL = async (e) => {
        ...
        var config = {
            method: 'post',
            url: `${Appconfig.apiUrl}reports/auraDownlinePL`,
            headers: {
                    ...
                    <div className='lg:mb-[24px] rounded-[.25rem]  lg:pb-[0] w-full bg-[#e0e6e6]  text-[#212529] [word-wrap:break-word] border-[1px] border-[#000501] '>
                        <div className='!p-0 flex-auto'>
                            <div className='flex flex-wrap pt-[10px]'>
                                ...
                                <div className='px-[10px] mb-[1rem] flex items-center  justify-start gap-1 lg:!mb-[10px] flex-[0_0_auto] w-[50%] lg:w-[16.66%]'>
                                    <button onClick={() => {
                                        filterDownlinePL()
