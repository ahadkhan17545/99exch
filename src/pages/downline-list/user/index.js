...
import { Table, Modal, Button, Form, Input, Select, Pagination } from "antd";
...
function UserList() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <div className="flex items-center gap-x-4">
          <strong className="text-[#535353] font-extrabold text-[0.813rem]">
            {record.exposer_limit}
          </strong>
          <button onClick={() => editExposureLimit(true, record)}>
            <svg
              fill="#535353"
              className="w-[15px] h-[15px]"
              xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
      ...
      render: (_, record) => (
        <span className="font-extrabold text-[#212529] text-[0.813rem]">
          {/* {updateTotalBalance(record.noDeductbalance)} */}
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        const color = pl < 0 ? "#d50000" : "#535353";
        return (
          ...
          <li className="block float-left" title="Sports Setting">
            <button
              ...
              onClick={() => {
                ...
                setIsCricketBetLock(
                  record?.is_cricket_bet_lock == "Yes" ? true : false
                );
                setIsSoccerBetLock(
                  record?.is_soccer_bet_lock == "Yes" ? true : false
                );
                setIsTennisBetLock(
                  record?.is_tennis_bet_lock == "Yes" ? true : false
                );
                setIsCasinoBetLock(
                  record?.is_casino_bet_lock == "Yes" ? true : false
                );
      ...
      axios(config)
        .then(function (response) {
          if (response.data.result != "0") {
            NotificationManager.success(
              "Exposer Limit Updated Successfully.",
              "",
              3000
            );
  ...
  return (
    <>
              ...
              userOpenBet.map((bet) => {
                return (
                  <tr className="bg-[#ccc] text-center">
                    ...
                    <td
                      className="h-[40px] px-[4px] text-[.813rem] text-[#535353] cursor-pointer"
                      onClick={() =>
      ...
      <Modal
        title={`Edit Exposure Limit - ${userRefData.user_name}`}
        className="rollingcommission-model relative top-1 lg:top-7 lg:!w-[34vw]"
        onCancel={() => setEditExposureLimitModal(false)}
        footer={null}
        open={editExposureLimitModal}
      >
        <div className="grid grid-cols-12">
          <div className="col-span-12 px-[1rem]">
            <Form
              form={exposerLimitForm}
              className="rolling-modal my-[15px] ml-[15px]"
              name="basic"
              labelCol={{
                span: 5,
              }}
            ...
            >
              <div className="grid grid-cols-12 mb-[1rem]">
                ...
                <div className="col-span-10 lg:px-[1rem]">
                  <b>{currentExposureLimit}</b>
                </div>
              </div>
              <Form.Item
                label="New"
              ...
              >
                <Button
                  type="primary"
                  htmlType="submit"
                  className="mt-[1rem] mx-[10px] lg:mx-[0px] lg:ml-[10px]"
                  disabled={button}
                  style={{
                    background:
                ...
                <Button
                  type="primary"
                  className="mt-[1rem] lg:ml-[10px]"
                  style={{
                    background:
                      "linear-gradient(-180deg, #b8beca 0%, #989595 100%)",
                    color: "#212529",
                  }}
                >
                  Cancel
      ...
      <div className="grid grid-cols-12 relative  px-[15px] lg:px-[30px] my-[28px]  lg:px-[0px] lg:top-[0px]">
            ...
            <div className="grid grid-cols-12">
              <div className="col-span-12 py-[20px]">
                ...
                >
                  ...
                  >
                    <Input className="lg:ml-[10px]" placeholder="Username..." />
                  </Form.Item>
                  ...
                  {/* <Form.Item
                                    ...
                                    >
                                        <Input className='lg:ml-[10px]' placeholder='Name...' />
                                    </Form.Item> */}
                  ...
                  {/* {!isCommission &&
                                        ...
                                        >
                                            ...
                                            <Input type='number'
                                                max={uplineUserData?.commission ? uplineUserData?.commission : userInfo?.master_commision}
                                                min={0} className='lg:ml-[10px]' placeholder='Commission...' />
                                        </Form.Item>
                                    } */}
                  <Form.Item
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Exposure Limit is required.",
                      },
                    ]}
                  >
                    <Input
                  ...
                  {/* <Form.Item
                                    ...
                                    >
                                        <Input className='lg:ml-[10px]' type='text' placeholder='Mobile Number ..' max={10} />
                                    </Form.Item> */}
                  {/* <Form.Item
                                        name="password"
                                        label="Password"
                                    ...
                                    >
                                        <Input.Password className='lg:ml-[10px]' placeholder='Password...' />
                                    </Form.Item> */}
                  <Form.Item
                    label="Password"
                    name="password"
                  ...
                  {/* <Form.Item
                                    ...
                                    >
                                        <Input.Password className='lg:ml-[10px]' placeholder='Confirm Password...' />
                                    </Form.Item> */}
                  {/* <Form.Item
                                    ...
                                    >
                                        <div className="form-check form-check-inline float-left inline-flex items-center pl-[2px] mr-[.75rem] relative !ml-[.5rem] min-h-[1.5rem] mb-[.125rem]" >
                                            <label htmlFor="chipSummaryOnOFF" className="switch switch-label switch-primary switch-lg w-[56px] h-[30px] inline-block mb-0 text-[0.938rem] leading-[28px]">
                                                <input id='chipSummaryOnOFF' name="chipSummaryOnOFF" type="checkbox" className="switch-input hidden" checked={isCommission} onChange={() => setIsCommission(!isCommission)} />
                  ...
                  {/* {isCommission && (
                                        <>
                                            ...
                                            >
                                                <Input type='number' className='lg:ml-[10px]' placeholder='0' />
                                            </Form.Item>
                                            <Form.Item
                                                label="Matka"
                  ...
                  {/* <Form.Item
                                    ...
                                    >
                                        <Input.Password className='lg:ml-[10px]' placeholder='Master Password...' />
                                    </Form.Item> */}
                  <Form.Item
                    wrapperCol={{
                      span: 16,
        ...
        <div className="col-span-12 bg-[#fff] text-[#3b5160] border-b-[1px] border-b-[#7e97a7] mb-[15px] w-full pt-[7px] px-[0] lg:pb-[5px] mt-[15px]">
          ...
          <dl className="total_dl w-[100%] lg:w-[14.96815%] px-[20px] py-[7px] lg:px-[10px] lg:py-[0px] float-left  border-b-[1px] border-b-[#d2d2d2] lg:border-b-[0px] lg:border-r-[1px] lg:border-r-[#d2d2d2]  m-0">
            ...
            <dd className="text-[0.938rem] text-[#d50000] leading-[20px] font-bold mb-0">
              {`IRP `}
          ...
          <dl className="total_dl w-[100%] lg:w-[14.96815%] px-[20px] py-[7px] lg:px-[10px] lg:py-[0px] float-left  border-b-[1px] border-b-[#d2d2d2] lg:border-b-[0px] lg:border-r-[1px] lg:border-r-[#d2d2d2]  m-0">
            ...
            >
              <span className="text-[#d50000]">
                {" "}
                {uplinePL ? "IRP " + uplinePL.toFixed(2) : "0"}
              </span>
            </dd>
          </dl>
        </div>
        ...
        <div className="col-span-12 ">
          <div className="bg-[#fff] border-[1px] border-[#0000002d] rounded-[.375rem] ">
            <div className="p-[1.25rem] flex-auto ">
              <Table
                title={() => (
                  <div className="grid grid-cols-12">
