...
function EventOpenBetting() {
    ...
    function getOpenBetsEventData() {
        ...
        var config = {
            method: "post",
            url: `${Appconfig.apiUrl}betting/getOpenBetsEventData`,
            headers: {
    ...
    const columns = [
        ...
        },
        {
            ...
            sorter: true,
            render: (_, record) => (
                <span className='font-extrabold text-[#315195] text-[0.813rem] ml-[5px]' onClick={() => navigateToDetails(record.match_id)}>{record.event_name}</span>
            ),
        },
        {
            title: 'Date',
...
export default EventOpenBetting;
