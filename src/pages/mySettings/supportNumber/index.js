...
function SupportNumber() {
    ...
    function getNumbers() {
        ...
        var config = {
            method: "post",
            url: `${Appconfig.apiUrl}numbers/getNumbers`,
            headers: {
    ...
    function addMessage() {
        ...
        if (formData.mob_num.trim()) {
            ...
            if (id) {
                ...
                config = {
                    method: "post",
                    url: `${Appconfig.apiUrl}numbers/updateNumbers`,
                    headers: {
                        "Content-Type": "application/json",
                    },
                    data: data,
                ...
                config = {
                    method: "post",
                    url: `${Appconfig.apiUrl}numbers/addNumbers`,
                    headers: {
                        "Content-Type": "application/json",
                    },
                    data: data,
    ...
    function deleteNews(id) {
        ...
        var config = {
            method: "post",
            url: `${Appconfig.apiUrl}numbers/deleteNumbers`,
            headers: {
                "Content-Type": "application/json",
            },
            data: data,
    ...
    const columns = [
        {
            ...
            sorter: true,
            render: (_, record) => (
                <span className='font-extrabold text-[#212529] text-[0.813rem] ml-[5px]'>{record?.mob_num}</span>
            ),
        },
        {
            title: 'User Name',
        ...
        },
        {
            ...
            sorter: true,
            render: (_, record) => (
                <div className='flex items-center gap-x-4 ' onClick={() => editNumbers(record._id, record.mob_num)}>
            ...
            <Modal className='password-model relative top-1 lg:top-7 lg:!w-[34vw]'
                ...
                <div className='grid grid-cols-12'>
                    <div className='col-span-12 px-[6px] py-[5px] font-bold text-[0.875rem] rounded-t-[5px] h-[35px] bg-[linear-gradient(-180deg,_#535353_0%,_#000000_100%)] text-[#ffffff] flex flex-shrink-0 items-center justify-between'>
                        <h5 className='text-[0.938rem] font-bold mb-0 leading-normal'>{id ? 'Update Number' : 'Add Number'}</h5>
                        ...
                        <div className='grid grid-cols-12 lg:gap-x-6 '>
                            <div className='col-span-12 lg:col-span-6'>
                                <div className='mb-4 !text-[#23282c]'>
                                    <label className='inline-block mb-[.5rem] !text-[#23282c]' htmlFor="oldPassword">Mobile Number </label>
                                    <div className='relative flex flex-wrap items-stretch w-full text-[#23282c]'>
                                        <Input id='mob_num' name='mob_num' required
                                            onChange={(e) => setMobNum(e.target.value)} value={formData.mob_num} className='antd-password' placeholder="9098939332" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className='lg:block w-full lg:w-[40vw] '>
                        <div className='grid grid-cols-12'>
                            <div className='col-span-12 px-[6px] py-[5px] font-bold text-[0.875rem] rounded-[1px] h-[35px] bg-[linear-gradient(-180deg,_#2E4B5E_0%,_#243A48_82%)] text-[#ffffff] flex flex-shrink-0 items-center justify-between'>
                                <h5 className='text-[0.938rem] font-bold mb-0 leading-normal'>Add Number</h5>
                            </div>
