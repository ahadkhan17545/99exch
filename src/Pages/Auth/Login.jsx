                ...
                <div id="login" className="">
                  ...
                  <div className="flex items-center relative">
                    <input
                      ...
                      className="login-input w-full px-4 py-2 border border-gray-300 rounded user_input focus:outline-none focus:ring-2 focus:ring-[var(--theme2-bg)]"
                    />
                    <>
                  ...
                  <div className="flex justify-center items-center text-center relative">
                    <button
                      type="submit"
                      className="bg-[var(--theme1-bg)] text-[var(--secondary-color)] px-6 py-2 rounded w-full hover:bg-[var(--theme2-bg)] transition"
                    >
                      Login
                    </button>
                  ...
                  <div className="flex justify-center items-center text-center relative">
                    <button
                      type="button"
                      className="bg-[var(--theme1-bg)] text-[var(--secondary-color)] px-6 py-2 mt-1 rounded w-full hover:bg-[var(--theme2-bg)] transition"
                      onClick={() => loginDemoID()}
                      disabled={isDisabled}
                    >
                      Login with Demo ID
